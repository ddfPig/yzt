<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\terminus\index.html";i:1538297309;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
...
<script>
    ...
    <form>
        <div class="margin-bottom-5">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-add'" href="<?php echo url('index/terminus/terminalm_add'); ?>">新建</a>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        grid = $('#rangegrid').datagrid({
            methord: 'ccc',
            url: "<?php echo url('index/terminus/ini'); ?>",
            sortOrder: 'desc',
            idField: 'id',
            pageSize: 50,
            frozenColumns: [[
            ...
            onDblClickCell: function (index, field, value) {
                window.location.href = '/index.php/index/terminus/edit' +
        ...
        $("#dc").click(function (){
            ...
            $.messager.confirm('确认', '您确认要导出吗？', function (r) {
                ...
                if (r) {
                    ...
                    window.location.href =  "<?php echo url('index/terminus/daochu'); ?>?status="+status+"&keyword="+keyword;
                }
            });
        });
        ...
        $('#qy').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/terminus/qy'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
        ...
        $('#ty').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/terminus/ty'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
