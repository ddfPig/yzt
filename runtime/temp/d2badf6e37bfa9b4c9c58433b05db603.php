<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\customer\customer_add.html";i:1538269400;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
    ...
    <style>
        .breadcrumb {
            ...
            <div class="margin-bottom-5">
                ...
                <a class="easyui-linkbutton" data-options="iconCls:'icon-refresh'" href="<?php echo url('index/customer/customeradd'); ?>">刷新</a>
            </div>
            ...
            <div class="form_table2">
                ...
                <div class="row">
                    <form id="dd">
                        <ul>
                            <li><label>编码</label><input type="text" name="pkfgl_id" value="<?php echo $pkfgl_id; ?>" readonly="readonly"/></li>
                            <!--readonly="readonly"-->
                            <li><label for="name">姓名</label><input type="text" placeholder="必填" name="pkfgl_name" /></li>
                            <li><label>登录用户名</label><input type="text" placeholder="必填" name="pkfgl_username"/></li>
                            <li><label>登录密码</label><input type="text" placeholder="必填" name="pkfgl_code"/></li>
                            <li><label>手机号</label><input type="text" placeholder="必填" name="pkfgl_phone"/></li>
                            <li><label>固定电话</label><input type="text" name="pkfgl_landline"></li>
                            <li><label>QQ</label><input type="text" name="pkfgl_qq"></li>
                            <li><label>邮箱</label><input type="text" name="pkfgl_email" ></li>
                        </ul>
                    </form>
...
<script>
    function add(){
        $.ajax({
            url:"<?php echo url('index/customer/add'); ?>",
            type:"POST",
            data:$('#dd').serialize(),
