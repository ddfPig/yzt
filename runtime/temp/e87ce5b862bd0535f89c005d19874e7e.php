<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\rechargereward\index.html";i:1538269416;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
...
<script>
    ...
    <form>
        <div class="margin-bottom-5">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-add'" href="<?php echo url('index/rechargereward/rec_add'); ?>">新建</a>
...
<script type="text/javascript" >
    ...
    $(function(){
        ...
        grid = $('#rangegrid').datagrid({
            methord: 'get',
            url: "<?php echo url('index/rechargereward/ini'); ?>",
            sortOrder: 'desc',
            idField: 'id',
            pageSize: 50,
            frozenColumns: [[
            ...
            columns: [[
                {
                    field: 'reward_state', title: '状态'
                },
                {
                    field: 'reward_real', title: '实际充值金额'
                },
                {
                    field: 'reward_handsel', title: '奖励金额'
                },
                {
            ...
            onDblClickCell: function (index, field, value) {
                window.location.href = '/index.php/index/rechargereward/edit' +
        ...
        $("#dc").click(function (){
            ...
            $.messager.confirm('确认', '您确认要导出吗？', function (r) {
                if (r) {
                    window.location.href = "<?php echo url('index/rechargereward/daochu'); ?>";
                }
            });
        });
        ...
        function UpdateList() {
            $.ajax({
                url:"<?php echo url('index/rechargereward/sort'); ?>",
                type: "post",
                data: $("form").serialize(),
                success: function (s) {
                    var results = eval('('+s+')');
        ...
        $('#xg').click(function () {
            ...
            window.location.href = ' /index.php/index/rechargereward/edit?id=' + id;
        });
        ...
        $('#qy').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/rechargereward/qy'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
        ...
        $('#ty').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/rechargereward/ty'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
