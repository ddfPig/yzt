<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\introduction\index.html";i:1538290273;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
        ...
        .breadcrumb {
            ...
            <div class="form_table5">
                <div class="row1">
                    <form id="dd">
                    <ul>
                        <li><label>系统名称</label><input type="text" name="gxxtjj_name" value="<?php echo $data['gxxtjj_name']; ?>"/></li>
                        <li><label>系统版本</label><input type="text" name="gxxtjj_version" value="<?php echo $data['gxxtjj_version']; ?>"/></li>
                        <li><label style="line-height:16px;">服务电话</label><input type="text" name="gxxtjj_phone" value="<?php echo $data['gxxtjj_phone']; ?>"/></li>
                        <li><label>服务QQ</label><input type="text" name="gxxtjj_qq" value="<?php echo $data['gxxtjj_qq']; ?>"/></li>
                        <li><label>更多介绍</label><textarea style="width:80%;height:200px" name="gxxtjj_more" ><?php echo $data['gxxtjj_more']; ?></textarea></li>
                    </ul>
                    </form>
                </div>
            </div>
...
<script>
    function add(){
        $.ajax({
            url:"<?php echo url('index/introduction/intaddbutton'); ?>",
            type:"POST",
            data:$('#dd').serialize(),
            success:function(result){
                ...
                if(results.error == 1){
                    $.messager.alert('提示',results.msg,'info',function(){
                        window.location.href = "<?php echo url('index/introduction/index'); ?>";
                    });
                }else {
