<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\base\supplier_edit.html";i:1538187742;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
...
<input type="hidden" id="id" name="id" value="<?php echo $id; ?>">
    <ul>
        <li><label>供货商编码</label><input type="text" name="supplier_code" value="<?php echo $data['supplier_code']; ?>" readonly="readonly"/></li>
        <li><label>供货商简码</label><input type="text" name="supplier_scode" value="<?php echo $data['supplier_scode']; ?>" id="supplier_scode" readonly="readonly"/></li>

        <li><label>供货商名称</label><input type="text" placeholder="必填" name="supplier_name" value="<?php echo $data['supplier_name']; ?>" id="supplier_name" onchange="jianma()"/></li>
        <li><label>营业执照号</label><input type="text" placeholder="必填" name="business_license" value="<?php echo $data['business_license']; ?>" id="business_license"/></li>
        <li><label id="ipt_area">注册地址</label><textarea placeholder="必填" name="register_addr" id="register_addr"><?php echo $data['register_addr']; ?></textarea></li>
        <li><label id="ipt_area">生产/仓库地址</label><textarea placeholder="必填" name="warehouse_addr" id="warehouse_addr"><?php echo $data['warehouse_addr']; ?></textarea></li>
    </ul>
    ...
    <ul> 
		...
		<option value="<?php echo $vo['ID']; ?>" <?php if($data['province'] == $vo['ID']): ?> selected <?php endif; ?>}><?php echo $vo['Name']; ?></option>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</select></li>
        <li><label>县市</label><select name="city" id="city" style="width:173px;" onchange="is_city()">
		<option>请选择</option>
		...
		<option value="<?php echo $vo['ID']; ?>" <?php if($data['city'] == $vo['ID']): ?> selected <?php endif; ?>}><?php echo $vo['Name']; ?></option>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</select></li>
        <li><label>地区</label><select name="area" id="area" style="width:173px;" >
		...
		<option value="<?php echo $vo['ID']; ?>" <?php if($data['area'] == $vo['ID']): ?> selected <?php endif; ?>}><?php echo $vo['Name']; ?></option>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</select></li>
    
       <li><label>法定代表人</label><input type="text" name="legal_representative" value="<?php echo $data['legal_representative']; ?>" /></li>
        <li><label>企业负责人</label><input type="text" name="business_person" value="<?php echo $data['business_person']; ?>" /></li>
        <li><label>质量负责人</label><input type="text" name="quality_person" value="<?php echo $data['quality_person']; ?>" /></li>
    <li><label>联系人</label><input type="text" name="contacts_person" value="<?php echo $data['contacts_person']; ?>" /></li>
    <li><label>联系电话</label><input type="text" name="contacts_phone" id="contacts_phone" value="<?php echo $data['contacts_phone']; ?>" /></li>

</ul>
<ul> 
        <li><label>开户户名</label><input type="text" name="account_person" value="<?php echo $data['account_person']; ?>" /></li>
        <li><label>开户银行</label><input type="text" name="account_bank" value="<?php echo $data['account_bank']; ?>" /></li>
        <li><label>银行账号</label><input type="text" name="account_number" value="<?php echo $data['account_number']; ?>" /></li>
        ...
        <li>
            ...
            <select name="business_type">
                ...
                <option value=<?php echo $vo['id']; if($data['business_type'] == $vo['id']): ?> selected<?php endif; ?>><?php echo $vo['name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </li>
    ...
    <li><label>电子邮箱</label><input type="text" name="email" id="email" value="<?php echo $data['email']; ?>" /></li>
        <li><label>档案编号</label><input type="text" name="file_number" value="<?php echo $data['file_number']; ?>" readonly="readonly"/></li>
		<li><label>备注</label><textarea name="remarks" ><?php echo $data['remarks']; ?></textarea></li>
...
<input type="hidden" id="updateinfo" name="updateinfo" />
    ...
    <script>
        ...
        function submitForm() {
            $.ajax({
                url: '/index.php/index/base/supplier_edit_api',
                type: "POST",
                data: $('#ff').serialize(),
        ...
        $(function () {
            $('#rangegrid').datagrid({
                methord: 'get',
                url: '/index.php/index/base/supplier_cert_api?id='+$('#id').val(),
                sortName: 'ID',
                sortOrder: 'desc',
                idField: '',
                pageSize: 50,
                ...
                columns: [[
                    {
                        field: 'id', title: 'id', hidden: 'true', editor: { type: 'text' }, fit: true
            ...
            $("#a_save").click(function () {
                ...
                //if (IsSubmit) {
                    //IsSubmit = false;
                    $.post("/index.php/index/base/supplier_edit_api", $("form").serialize(),
                                function (s) {
                                    //IsSubmit = true;
                                    if (s.status == 1) {
