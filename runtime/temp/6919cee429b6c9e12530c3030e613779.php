<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\customer\customer_edit.html";i:1538269400;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
    ...
    <style>
        .breadcrumb {
            ...
            <div class="margin-bottom-5">
                ...
                <?php endif; ?>
                <a class="easyui-linkbutton" data-options="iconCls:'icon-list'" href="<?php echo url('index/customer/index'); ?>">列表</a>
                ...
                <div class="row">
                    <form id="dd">
                        <ul>
                            ...
                            <input type="hidden" name="pkfgl_admin_id" value="<?php echo $data['pkfgl_admin_id']; ?>"/>
                            <li><label>编码</label><input type="text" name="pkfgl_id" readonly="readonly" value="<?php echo $data['pkfgl_id']; ?>"/></li>
                            <li><label for="name">姓名</label><input type="text" placeholder="必填" name="pkfgl_name" value="<?php echo $data['pkfgl_name']; ?>" /></li>
                            <li><label>登录用户名</label><input type="text" placeholder="必填" name="pkfgl_username" value="<?php echo $data['pkfgl_username']; ?>" readonly="readonly"/></li>
                            <li><label>登录密码</label><input type="text" placeholder="必填" name="pkfgl_code" /></li>
                            <li><label>手机号</label><input type="text" placeholder="必填" name="pkfgl_phone" value="<?php echo $data['pkfgl_phone']; ?>"/></li>
                            <li><label>固定电话</label><input type="text" name="pkfgl_landline" value="<?php echo $data['pkfgl_landline']; ?>"></li>
                            <li><label>QQ</label><input type="text" name="pkfgl_qq" value="<?php echo $data['pkfgl_qq']; ?>"></li>
                            <li><label>邮箱</label><input type="text" name="pkfgl_email" value="<?php echo $data['pkfgl_email']; ?>"></li>
                        </ul>
                    </form>
...
<script>
    ...
    function edit(){
        $.ajax({
            url:"<?php echo url('index/customer/editbutton'); ?>",
            type:"POST",
            data:$('#dd').serialize(),
            success:function(result){
                ...
                if(results.error == 1){
                    $.messager.alert('提示',results.msg,'info',function(){
                        window.location.href = "<?php echo url('index/customer/index'); ?>";
                    });
                }else{
