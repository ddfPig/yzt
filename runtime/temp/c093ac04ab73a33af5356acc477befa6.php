<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\unit\unit_add.html";i:1538269425;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
    ...
    <style>
        .breadcrumb {
            ...
            <div class="form_table1">
                <form id="dd">
                <div class="row"><ul><li><label>状态</label><input type="text" readonly="readonly" name="dwgl_state"/></li></ul></div>
                <div class="row"><ul><li><label>名称</label><input type="text" placeholder="必填" name="dwgl_name"/></li></ul></div>
                <div class="row"><ul><li><label>创建人</label><input type="text" readonly="readonly" name="dwgl_create_name"/></li></ul></div>
                <div class="row"><ul><li><label>创建时间</label><input type="text" readonly="readonly" name="dwgl_create_time"/></li></ul></div>
                <div class="row"><ul><li><label>最后修改人</label><input type="text" readonly="readonly" name="dwgl_last_name"/></li></ul></div>
                <div class="row"><ul><li><label>最后修改时间</label><input type="text" readonly="readonly" name="dwgl_last_time"/></li></ul></div>
                </form>
            </div>
</div>
<script>
    function add(){
        $.ajax({
            url:"<?php echo url('index/unit/uaddbutton'); ?>",
            type:"POST",
            data:$('#dd').serialize(),
