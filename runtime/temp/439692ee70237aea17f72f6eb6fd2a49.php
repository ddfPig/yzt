<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\member\recharge_upd.html";i:1538276330;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
...
<script>
            ...
            <div class="form_table2" style="margin-top: 0">
                <div class="row">
                    ...
                    <form id="ff">
                        <ul>
                            <li>
                                <label>姓名</label><input type="text" readonly="readonly"  name="name" id="name"  value="<?php echo $data['name']; ?>"/></li>
                            <li>
                                <label>诊疗卡号</label><input type="text" readonly="readonly"  name="vip_num" id="vip_num" value="<?php echo $data['vip_num']; ?>" /></li>
                            
                            <li>
                                <label>手机号</label><input type="text" name="phone" id="phone"  readonly="readonly" value="<?php echo $data['phone']; ?>" /></li>
                            
                            <li>
                                <label>原收款方式</label><input type="text" name="old_pay_type" id="old_pay_type"  readonly="readonly"  value="<?php echo $data['pay_type']; ?>"/></li>
                        ...
                        <ul> 
                            <li>
                                <label>修改订单</label><input type="text" name="phone" id="phone"  readonly="readonly"  value="<?php echo $data['storage_num']; ?>"/></li>
                          
                            <li>
                                <label>创建人</label><input type="text" name="phone" id="phone"  readonly="readonly"  value="<?php echo $data['creation']; ?>"/></li>
                        
                            <li>
                                <label>创建日期</label><input type="text" name="phone" id="phone"  readonly="readonly"  value="<?php echo $data['creation_date']; ?>"/></li>
                            <li>
                                <label>最后修改人</label><input type="text" name="phone" id="phone" readonly="readonly"   value="<?php echo $data['upd_people']; ?>"/></li>
                            <li>
                                <label>最后修改日期</label><input type="text" name="phone" id="phone"  readonly="readonly"  value="<?php echo $data['upd_people_date']; ?>"/></li>
                           
                        </ul>
                        <ul> 
                               
                              <label>备注</label><textarea name="remark" id="remark"><?php echo $data['remark']; ?></textarea></li>
                        </ul>
    ...
    <input type="hidden" id="vipid" name="vipid" value="<?php echo $data['id']; ?>" >
    ...
    <script>
        ...
        function  save(){
			...
			if(pay_type_test==old_pay_type){
             ...
             $.ajax({
				url: "<?php echo url('index/member/recharge_edit'); ?>",
				type: 'POST',
				data: {        		                              
                    pay_type:pay_type,          
                    vipid:vipid,
