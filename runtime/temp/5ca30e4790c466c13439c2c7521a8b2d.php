<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\updatediary\updatediary_add.html";i:1538272506;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
    ...
    <style>
        .breadcrumb {
            ...
            <div class="form_table2">
                <div class="row">
                    <form id="dd" style="width:100%;height:100%;">
                        <ul>
                            <li><label>标题</label><input type="text"  name="gxrjgl_title" id="supplier_code" /></li>
                            <li><label>自定义时间</label><input type="text" data-options="editable:false"  name="gxrjgl_customize_time" class="easyui-datebox"  style="width:174px"/></li>
                            <li><label>内容</label><textarea style="width:170px;height:80px" name="gxrjgl_contents"></textarea></li>
                        </ul>
                    </form>
                </div>
            </div>
...
<script>
    function add(){
        $.ajax({
            url:"<?php echo url('index/updatediary/adddiarybutton'); ?>",
            type:"POST",
            data:$('#dd').serialize(),
