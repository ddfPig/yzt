<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\base\win_cert.html";i:1538112958;}*/ ?>
    ...
    $(function () {
        ...
        function List() {
			selectGrid = $('#selectGrid').datagrid({   
				url:'/index.php/index/base/supplier_cert?ran=' + Math.random() + '&keyword=' + encodeURI($("#keyword").val()),
				pageSize: 10,
				fit: true,
				frozenColumns: [[
