<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\base\medicine_edit.html";i:1538114838;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
...
<li>
    ...
    <select name="classify_id" id="classify_id">
		...
		<option value="<?php echo $vo['id']; ?>" <?php if($data['classify_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
		<?php endforeach; endif; else: echo "" ;endif; ?>
    </select>
</li>    
        <li><label>药品编码</label><input type="text" name="code" id="code" value="<?php echo $data['code']; ?>"/></li><!--readonly="readonly" 不可修改-->
        <li><label>药品简码</label><input type="text" name="scode" id="scode" value="<?php echo $data['scode']; ?>" readonly="readonly"/></li>
		<li><label>通用名称</label><input type="text" placeholder="必填" name="uname" id="uname" value="<?php echo $data['uname']; ?>" onchange="jianma()"/></li>
        <li><label>商品名</label><input type="text" name="name" id="name" value="<?php echo $data['name']; ?>"/></li>
        <li><label>规格</label><input type="text" name="specification" id="specification" value="<?php echo $data['specification']; ?>"/></li>

     	
        <li><label>生产厂商</label><input type="text" name="manufacturer" id="manufacturer" value="<?php echo $data['manufacturer']; ?>"/></li>
        <li><label>产地</label><input type="text" name="produce_place" id="produce_place" value="<?php echo $data['produce_place']; ?>"/></li>
          </ul>
        ...
        <li>
            ...
            <select name="unit_id" id="unit_id">
				...
				<option value="<?php echo $vo['id']; ?>" <?php if($data['unit_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </li>
     	<li>
            ...
            <select name="dosage_id" id="dosage_id">
				...
				<option value="<?php echo $vo['id']; ?>" <?php if($data['dosage_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        	...
        	<select name="effect_id" id="effect_id">
				...
				<option value="<?php echo $vo['id']; ?>" <?php if($data['effect_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </li>
                <li>
			...
			<select name="prescription" id="prescription">
				...
				<option value="<?php echo $vo['id']; ?>" <?php if($data['prescription'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </li>
        <li>
			...
			<select name="special" id="special">
				...
				<option value=0 <?php if($data['special'] == '0'): ?>selected<?php endif; ?>>否</option>
				<option value=1 <?php if($data['special'] == '1'): ?>selected<?php endif; ?>>是</option>
            </select>
        </li>
       
        <li><label>批准文号</label><input type="text"  name="approval_number" id="approval_number" value="<?php echo $data['approval_number']; ?>"/></li>
        <li><label style="line-height:16px;">批准文号<br />有效期</label><input type="text" name="approval_number_effect" id="approval_number_effect" value="<?php echo $data['approval_number_effect']; ?>" data-options="formatter:formatter,editable:false" class="easyui-datebox" style="width:170px" /></li>
	</ul>
        
        <ul>
            <li><label>适用诊疗范围</label><input type="text" placeholder="请双击选择" style="border:1px solid #1BBC9B" name="scope" id="scope_show" ondblclick="show_scope()" readonly="readonly" name="scope" value="<?php echo $data['scope']; ?>"/></li>
			<li><label>性状</label><input type="text" name="character" id="character" value="<?php echo $data['character']; ?>"/></li>
			<li><label>功能主治</label><input type="text" name="function" id="function" value="<?php echo $data['function']; ?>"/></li>
            <li><label>整箱数量</label><input type="text" name="box_number" id="box_number" value="<?php echo $data['box_number']; ?>"/></li>
			<li><label>商品条码</label><input type="text" name="bar_code" id="bar_code" value="<?php echo $data['bar_code']; ?>"/></li>
            <li><label>库存上限</label><input type="text" name="stock_max" id="stock_max" value="<?php echo $data['stock_max']; ?>"/></li>
            <li><label>库存下限</label><input type="text" name="stock_min" id="stock_min" value="<?php echo $data['stock_min']; ?>"/></li>
</ul>
<ul>         

			<li><label>最低收款价</label><input type="text" name="price_min" id="price_min" value="<?php echo $data['price_min']; ?>"/></li>
			<li><label>收款单价</label><input type="text" name="price" id="price" value="<?php echo $data['price']; ?>"/></li>
			<li><label>最高收款价</label><input type="text" name="price_max" id="price_max" value="<?php echo $data['price_max']; ?>"/></li>
            <li><label>储存方法</label><input type="text" name="storage_method" id="storage_method" value="<?php echo $data['storage_method']; ?>"/></li>
            <li><label>养护方法</label><input type="text" name="maintenance_method" id="maintenance_method" value="<?php echo $data['maintenance_method']; ?>"/></li>
            <li><label>档案信息</label><input type="text" name="archival_information" id="archival_information" value="<?php echo $data['archival_information']; ?>"/></li>
            <li><label>备注</label><input type="text" name="remarks" id="remarks" value="<?php echo $data['remarks']; ?>"/></li>
        </ul>
</form>
    </div>
