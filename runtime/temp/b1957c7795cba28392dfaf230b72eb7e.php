<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\staff\staff_edit.html";i:1538269418;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
        ...
        .breadcrumb {
            ...
            <div class="form_table1">
                <form id="dd">
                    ...
                    <div class="row"><ul><li><label>状态</label><input type="text" readonly="readonly" name="zylx_state" value="<?php if($data['zylx_state'] == 1): ?>已启用<?php else: ?>已停用<?php endif; ?>"/></li></ul></div>
                    <div class="row"><ul><li><label>名称</label><input type="text" placeholder="必填" name="zylx_name" value="<?php echo $data['zylx_name']; ?>"/></li></ul></div>
                    <div class="row"><ul><li><label>创建人</label><input type="text" readonly="readonly" name="zylx_create_name" value="<?php echo $data['zylx_create_name']; ?>"/></li></ul></div>
                    <div class="row"><ul><li><label>创建时间</label><input type="text" readonly="readonly" name="zylx_create_time" value="<?php echo date('Y-m-d H:i:s',$data['zylx_create_time']); ?>"/></li></ul></div>
                    <div class="row"><ul><li><label>最后修改人</label><input type="text" readonly="readonly" name="zylx_last_name" value="<?php echo $data['zylx_last_name']; ?>"/></li></ul></div>
                    <div class="row"><ul><li><label>最后修改时间</label><input type="text" readonly="readonly" name="zylx_last_time" value="<?php echo date('Y-m-d H:i:s',$data['zylx_last_time']); ?>"/></li></ul></div>
                </form>
            </div>
</div>
<script>
    function add(){
        $.ajax({
            url:"<?php echo url('index/staff/staeditbutton'); ?>",
            type:"POST",
            data:$('#dd').serialize(),
