<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\treatment\index.html";i:1538269423;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
    ...
    <style>
        .breadcrumb {
            ...
            <div class="margin-bottom-5">
                <a class="easyui-linkbutton" data-options="iconCls:'icon-add'" href="<?php echo url('index/treatment/treatmentadd'); ?>">新建</a>
                ...
                <a class="easyui-linkbutton" data-options="iconCls:'icon-refresh'" href="<?php echo url('index/treatment/index'); ?>">刷新</a>
            </div>
...
<script type="text/javascript" >
        ...
        $(function(){
            ...
            grid = $('#rangegrid').datagrid({
                methord: 'get',
                url: "<?php echo url('index/treatment/ini'); ?>",
                sortOrder: 'desc',
                idField: 'id',
                pageSize: 50,
                frozenColumns: [[
                ...
                columns: [[
                    {
                        field: 'syzl_state', title: '状态'
                    },
                    {
                        field: 'syzl_name', title: '名称'
                    },
                    {
                ...
                onDblClickCell: function (index, field, value) {
                    window.location.href = '/index.php/index/treatment/edit' +
            ...
            $("#dc").click(function (){
                ...
                $.messager.confirm('确认', '您确认要导出吗？', function (r) {
                    if (r) {
                        window.location.href = "<?php echo url('index/treatment/daochu'); ?>";
                    }
                });
            });
            ...
            function UpdateList() {
                $.ajax({
                    url:"<?php echo url('index/treatment/sort'); ?>",
                    type: "post",
                    data: $("form").serialize(),
                    success: function (s) {
                        var results = eval('('+s+')');
        ...
        //修改按钮
        $('#xg').click(function () {
            var rows = $('#drangegrid').datagrid('getSelections');
            if (rows.length != 1){
            ...
            window.location.href = ' /index.php/index/treatment/edit?id=' + id;
        });
        ...
        $('#qy').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/treatment/qy'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
        ...
        $('#ty').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/treatment/ty'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
