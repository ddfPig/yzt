<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\cure\win_medicine.html";i:1538112923;}*/ ?>
    ...
    $(function () {
        ...
        function List() {
			selectGrid = $('#selectGrid').datagrid({   
				url:'/index.php/index/base/medicine_search?ran=' + Math.random() + '&keyword=' + encodeURI($("#keyword").val()),
				pageSize: 10,
				fit: true,
				frozenColumns: [[
				...
				columns:[[
					...
					{ field: 'classify_id', title: '药品分类' },
					{ field: 'code', title: '药品编码' },
