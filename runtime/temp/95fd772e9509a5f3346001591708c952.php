<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\role\addRole.html";i:1538208568;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
                ...
                <form action="" method="post" id="admin_user">
                    <div class="row">
                        <ul>
                            ...
                            <li><label>用户组名称</label><input type="text" name="title" /></li>
                            <li class="qk"><label>显示状态</label>
                                <span class="radioSpan">
                                    <input type="radio" name="status" value="1" checked>显示</input>
                                <input type="radio" name="status" value="0" >隐藏</input>
                    </span></li>
                        </ul>
...
<script>
    ...
    function saveRole(){
        $('#admin_user').form('submit',{
            url: "<?php echo url('index/role/insertRole'); ?>",
            onSubmit: function(){
