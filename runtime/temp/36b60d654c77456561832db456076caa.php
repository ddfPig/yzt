<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\pharmacy\index.html";i:1538269409;s:74:"C:\phpStudy\PHPTutorial\WWW\tp\application\index\view\common\userinfo.html";i:1538038290;}*/ ?>
    ...
    <style>
        .breadcrumb {
            ...
            <div class="margin-bottom-5">
                <a class="easyui-linkbutton" data-options="iconCls:'icon-add'" href="<?php echo url('index/pharmacy/pharmacyadd'); ?>">新建</a>
...
<script type="text/javascript" >
    ...
    $(function(){
        ...
        grid = $('#rangegrid').datagrid({
            methord: 'get',
            url: "<?php echo url('index/pharmacy/ini'); ?>",
            sortOrder: 'desc',
            idField: 'id',
            pageSize: 50,
            frozenColumns: [[
            ...
            columns: [[
                {
                    field: 'jxgl_state', title: '状态'
                },
                {
                    field: 'jxgl_name', title: '名称'
                },
                {
            ...
            onDblClickCell: function (index, field, value) {
                window.location.href = '/index.php/index/pharmacy/edit' +
        ...
        $("#dc").click(function (){
            ...
            $.messager.confirm('确认', '您确认要导出吗？', function (r) {
                if (r) {
                    window.location.href = "<?php echo url('index/pharmacy/daochu'); ?>";
                }
            });
        });
        ...
        function UpdateList() {
            $.ajax({
                url:"<?php echo url('index/pharmacy/sort'); ?>",
                type: "post",
                data: $("form").serialize(),
                success: function (s) {
                    var results = eval('('+s+')');
        ...
        $('#xg').click(function () {
            ...
            window.location.href = ' /index.php/index/pharmacy/edit?id=' + id;
        });
        ...
        $('#qy').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/pharmacy/qy'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
        ...
        $('#ty').click(function(){
            ...
            $.ajax({
                url: "<?php echo url('index/pharmacy/ty'); ?>",
                type: "post",
                data: {ids:ids},
                success: function (s) {
                    if (s.error == 1) {
