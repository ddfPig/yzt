<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\phpStudy\PHPTutorial\WWW\tp/application/index\view\account\getRole.html";i:1538021199;}*/ ?>
...
<script type="text/javascript">
    ...
    function List() {
        grid = $('#dwgrid').datagrid({
            method: 'get',
            url:"<?php echo url('index/account/getRoleList'); ?>",
            sortName: 'id',
            sortOrder: 'desc',
            idField: 'id',
            pageSize: 10,
            ...
            columns: [[
                { field: 'title', title: '角色名称', fit: true },
            ]],
            fit: true,
            pagination: true,
            rownumbers: true,
