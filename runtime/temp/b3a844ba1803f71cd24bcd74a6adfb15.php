<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"C:\phpStudy\PHPTutorial\WWW\tp\public/../application/index\view\purchase\SelSupply.html";i:1538057302;}*/ ?>
...
<script type="text/javascript">
    ...
    function List() {
        grid = $('#dwgrid').datagrid({
            method: 'get',
            url:"<?php echo url('index/purchase/getYP'); ?>?ran=" + Math.random() + "&keyword=" + encodeURI($("#keyword").val()),
            sortName: 'id',
            sortOrder: 'desc',
            idField: 'id',
            pageSize: 10,
            ...
            columns: [[
                ...
                { field: 'supplier_name', title: '供货单位名称', fit: true },
            ]],
            fit: true,
            pagination: true,
            rownumbers: true,
